...
#define I2C_GPS_COMMAND                              01 //(write only)
        ...
        #define I2C_GPS_COMMAND_UPDATE_PIDS   0x04      // update PI and PID controllers from the PID registers
        #define I2C_GPS_COMMAND_NAV_OVERRIDE  0x05      // do not nav since we tring to controll the copter manually
        #define I2C_GPS_COMMAND_STOP_NAV      0x06
...
#define I2C_GPS_REG_RES2                            04
#define I2C_GPS_REG_RES3                            05
#define I2C_GPS_REG_RES4                            06
...
#define I2C_GPS_WP_RADIUS                           49    //Radius of the wp in cm, within this radius we consider the wp reached

#define I2C_GPS_NAV_FLAGS                           51    //Navigation flags uint8_t to be defined


#define I2C_GPS_HOLD_P                              52    // poshold_P  *100 uint8_t
#define I2C_GPS_HOLD_I                              53    // poshold_I  *100 uint8_t
#define I2C_GPS_HOLD_IMAX                           54    // poshold_IMAX *1 uint8_t

#define I2C_GPS_HOLD_RATE_P                         55    // poshold_rate_P  *10 uint8_t
#define I2C_GPS_HOLD_RATE_I                         56    // poshold_rate_I  *100 uint8_t
#define I2C_GPS_HOLD_RATE_D                         57    // poshold_rate_D  *1000 uint8_t
#define I2C_GPS_HOLD_RATE_IMAX                      58    // poshold_rate_IMAX *1 uint8_t

#define I2C_GPS_NAV_P                               59    // nav_P  *10 uint8_t
#define I2C_GPS_NAV_I                               60    // nav_I  *100 uint8_t
#define I2C_GPS_NAV_D                               61    // nav_D  *1000 uint8_t
