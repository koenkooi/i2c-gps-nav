...
#define I2C_GPS_HOLD_RATE_P                         55    // poshold_rate_P  *100 uint16_t
...
#define I2C_GPS_NAV_P                               59    // nav_P  *100 uint16_t
...
//PID values
  ...
  uint8_t              poshold_rate_p;  	  // *100
  uint8_t              poshold_rate_i;	    	  // *10
